    ...
    <footer className="bg-secondary py-16">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <span className="text-muted-foreground">waqar.lexumsoft@gmail.com</span>
              </div>
              <div className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-muted-foreground">+923282828885</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center text-muted-foreground">
          <p>&copy; {currentYear} Waqar Khan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
